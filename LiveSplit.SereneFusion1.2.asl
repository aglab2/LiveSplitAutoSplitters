state("project64")
{
	byte Stars : "project64.exe", 0xD6A1C, 0x20e61d;
	byte level : "project64.exe", 0xD6A1C, 0x1ff477;
	byte music : "project64.exe", 0xD6A1C, 0xf6fb2;
	int anim: "project64.exe", 0xD6A1C, 0x20e580;
	int time: "project64.exe", 0xD6A1C, 0x135690;
