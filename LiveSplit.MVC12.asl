state("project64")
{
	byte Stars : 0xD6A1C, 0x1B6AA4;                 
	byte level : "project64.exe", 0xD6A1C, 0x181814;      
	byte music : "project64.exe", 0xD6A1C, 0xa45b6;  
	int anim: "project64.exe", 0xD6A1C, 0x1B6A08;    
	int time: "project64.exe", 0xD6A1C, 0x184abc;         
