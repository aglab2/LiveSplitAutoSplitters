state("project64")
{
	byte Stars : "project64.exe", 0xD6A1C, 0x1903B8;
	byte level : "project64.exe", 0xD6A1C, 0x18210a;
	byte music : "project64.exe", 0xD6A1C, 0x9e3c2;
	int anim: "project64.exe", 0xD6A1C, 0x19031c;
...
start
{
	...
	if (settings["LI"])
		...
		if(settings["DelA"] && old.time > current.time)
